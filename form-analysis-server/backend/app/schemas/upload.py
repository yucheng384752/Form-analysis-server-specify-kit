    ...
    model_config = ConfigDict(
        json_schema_extra={
            "example": {
                ...
                "fields": {"file": "檔案內容（CSV 或 Excel 格式）"},
...
class UpdateUploadContentRequest(BaseModel):
    ...
    reason_id: uuid.UUID | None = Field(None, description="選擇的修改原因 ID（可選）")
    reason_text: str | None = Field(None, description="補充原因文字（可選）")
